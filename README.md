...
Download `Moyai-1.0.4-x64.msi` and its `.sha256` file from [Moyai v1.0.4](https://github.com/katsushoe/Moyai/releases/tag/v1.0.4). Verify both SHA-256 values match, then run the MSI as an administrator. Moyai is installed in `C:\Moyai`.
