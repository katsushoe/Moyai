...
[Moyai v1.0.7](https://github.com/katsushoe/Moyai/releases/tag/v1.0.7)から`Moyai-1.0.7-x64.msi`と`.sha256`ファイルをダウンロードします。両方のSHA-256値が一致することを確認し、管理者権限でMSIを実行してください。Moyaiは`C:\Moyai`へインストールされます。
