...
public sealed class SqliteProjectRepositoryTests
{
    ...
    public async Task ProjectServiceSupportsCrudArchivingAndEventHistory()
    {
        ...
        var update = new UpdateProjectCommand("Moyai", "Moyai Next", "Description", "{}", "Moyai", "moyai@example.com", "origin", "develop", created.Revision, "agent", "codex");
    ...
    public async Task UpdateAsyncRejectsStaleRevisionWithoutEventOrDataChange()
    {
        ...
        var update = new UpdateProjectCommand("Moyai", "Changed", null, null, null, null, "origin", null, created.Revision + 1, "agent", "codex");
